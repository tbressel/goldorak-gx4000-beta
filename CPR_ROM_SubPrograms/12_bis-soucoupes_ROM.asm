...
; on reinit les coordonnées du sprite
	...
	db		ITEM_10_PTS,ITEM_10_PTS,ITEM_AJOUTE_1VIE,ITEM_20_PTS,ITEM_10_PTS,ITEM_50_PTS,ITEM_FULL_NRJ,ITEM_AJOUTE_1VIE
	...
	db		ITEM_10_PTS,ITEM_AJOUTE_1VIE,ITEM_50_PTS,ITEM_10_PTS,ITEM_POWERUP,ITEM_AJOUTE_1VIE,ITEM_10_PTS,ITEM_FULL_NRJ
	...
	db		ITEM_AJOUTE_1VIE,ITEM_FULL_NRJ,ITEM_AJOUTE_1VIE,ITEM_FULL_NRJ,ITEM_POWERUP,ITEM_AJOUTE_1VIE,ITEM_50_PTS,ITEM_10_PTS
